  ...
  render() {
    return (
      ...
      <div className="container">
        <div id="myCarousel" className="carousel slide" data-ride="carousel">
          ...
          <div className="carousel-inner" role="listbox">
            <div className="item active">
              <img src={Slider1} alt="Chania" width="100%" height="400" />
            ...
            <div className="item">
              <img src={Slider2} alt="Chania" width="100%" height="400"/>
              <div className="carousel-caption">
                <h3>Chania</h3>
                <p>The atmosphere in Chania has a touch of Florence and Venice.</p>
              </div>
            ...
            <div className="item">
              <img src={Slider3} alt="Flower" width="100%" height="400"/>
              <div className="carousel-caption">
                <h3>Flowers</h3>
            ...
            <div className="item">
              <img src={Slider4} alt="Flower" width="100%" height="400"/>
              <div className="carousel-caption">
                <h3>Flowers</h3>
                <p>Beautiful flowers in Kolymbari, Crete.</p>
              </div>
        ...
        <div className="text-center text-uppercase vspacing"><h2>About <span className="wlast">sears holdings india</span></h2></div>
        <div className="row">
            <div  className="outer">
        ...
        <div className="text-center text-uppercase vspacing"><h3>sears holdings india <span className="wlast">stands for</span></h3></div>
        <div className="row">
        ...
        <div className="text-center text-uppercase vspacing"><h3>About<span className="wlast"> sears holdings Corporation </span></h3></div>
        <div className="row">
              <div  className="outer">
        ...
        <div className="text-center text-uppercase vspacing"><h3>Delve into the history of a <span className="wlast"> century-old gaint </span></h3></div>
        <div className="row">
        ...
        <div className="text-center text-uppercase vspacing"><h3>We swear by <span className="wlast"> one mission, four key results and seven cultural beliefs </span></h3></div>
        <div className="row">
